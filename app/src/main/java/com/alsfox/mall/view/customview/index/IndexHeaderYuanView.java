...
public class IndexHeaderYuanView extends LinearLayout {
    ...
    public void getDataList(List<IndexDaohangBean> indexDaohangInfoBeans) {
    ...
    public void getUrlDataList(List<IndexDaohangBean> indexDaohangInfoBeans) {
        if (header_yuan_ly == null) return;
        if (indexDaohangInfoBeans.isEmpty()) return;
        if (indexDaohangInfoBeanList != null && indexDaohangInfoBeanList.size() > 0 && indexDaohangInfoBeans.containsAll(indexDaohangInfoBeanList))
            return;
        else
