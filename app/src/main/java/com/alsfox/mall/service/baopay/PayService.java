package com.alsfox.mall.service.baopay;
...
import static com.alsfox.mall.service.ServiceConstant.SELLER;
...
public class PayService {
    ...
    public String getOrderInfo(String orderNo, String orderTitle, String orderDec, String price, String payType) {
        // 签约合作者身份ID
        String orderInfo = "partner=" + "\"" + ServiceConstant.PARTNER + "\"";
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + RequestUrls.ALIPAY_ASYNC_CALLBACK_URL + "?pay_from=" + payType + "\"";
...
//        orderInfo += "&pay_from=" + "\"" + payType + "\"";
    ...
    public String sign(String content) {
        return SignUtils.sign(content, ServiceConstant.RSA_PRIVATE);
    }
