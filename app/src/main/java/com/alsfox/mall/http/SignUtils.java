...
public class SignUtils {
     ...
     * key的值
     */
    public static final String KEY_PRIVATE_STR = "web_service_key";
     ...
     * 接口版本号
     */
    public static final String WEB_VERSION_CODE = "1.01";
    ...
    public static Map<String, Object> getParameters() {
        ...
        params.put(WEB_VERSION, WEB_VERSION_CODE);//接口版本号
        return params;
    }
}
