...
public class IndexMokuaiInfoBean {

    private List<IndexMokuaiContentInfoBean> indexMoudleContentList;// 模块内容列表
    ...
    public List<IndexMokuaiContentInfoBean> getIndexMoudleContentList() {
        return indexMoudleContentList;
    }

    public void setIndexMoudleContentList(List<IndexMokuaiContentInfoBean> indexMoudleContentList) {
